...
subroutine ocean_blob_update(Time, Thickness, T_prog, Dens, Ext_mode, Adv_vel, Velocity, L_system, EL_diag)
 ...
 call mpp_sum(nblob)
  ...
  !print *, 'stuff_ocean_blobs.F90', Thickness%mass_source(23,22,30)
  ...
  !print *, 'stuff_ocean_blobs_2.F90', Thickness%mass_source(23,22,30)
  ...
  enddo
  !print *, 'stuff_ocean_blobs_3.F90', Thickness%mass_source(23,22,30)
...
subroutine ocean_blob_cell_update(Time, Thickness, Dens, T_prog, Ext_mode, L_system, EL_diag)
  ...
  !print *, 'stuff_ocean_blobs_4.F90', Thickness%mass_source(23,22,30)
